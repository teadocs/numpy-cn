...
- [NumPy的范围](https://numpy.org/neps/scope.html)
- [当前路线图roadmap](https://numpy.org/neps/roadmap.html)
- [愿望清单](https://github.com/numpy/numpy/issues?q=is%3Aopen+is%3Aissue+label%3A%2223+-+Wish+List%22)

## Meta-NEPs (NEPs 相关的 NEPs 或者进度)

- [NEP 0 — 目的和过程](https://numpy.org/neps/nep-0000.html)
- [NEP 23 — 向后兼容性和弃用策略](https://numpy.org/neps/nep-0023-backwards-compatibility.html)
- [NEP X — 模板和说明](https://numpy.org/neps/nep-template.html)
