...
what are the names of the “[fields](https://numpy.org/devdocs/glossary.html#term-field)” of the structure,
by which they can be [accessed](arrays.indexing.html#arrays-indexing-fields),
what is the data-type of each [field](https://numpy.org/devdocs/glossary.html#term-field), and
...
[[dtype](generated/numpy.dtype.html#numpy.dtype).subdtype](generated/numpy.dtype.subdtype.html#numpy.dtype.subdtype) | Tuple (item_dtype, shape) if this dtype describes a sub-array, and None otherwise.
---|---
...
[dtype.descr](generated/numpy.dtype.descr.html#numpy.dtype.descr) | __array_interface__ description of the data-type.
