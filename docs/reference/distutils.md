...
*class *``numpy.distutils.misc_util.````Configuration``(*package_name=None*, *parent_name=None*, *top_path=None*, *package_path=None*, ***attrs*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L731-L2070)[¶](#numpy.distutils.misc_util.Configuration)
...
``todict``(*self*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L838-L855)[¶](#numpy.distutils.misc_util.Configuration.todict)
...
``get_distribution``(*self*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L881-L884)[¶](#numpy.distutils.misc_util.Configuration.get_distribution)

Return the distutils distribution object for self.


``get_subpackage``(*self*, *subpackage_name*, *subpackage_path=None*, *parent_name=None*, *caller_level=1*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L949-L1008)[¶](#numpy.distutils.misc_util.Configuration.get_subpackage)
...
``add_subpackage``(*self*, *subpackage_name*, *subpackage_path=None*, *standalone=False*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1010-L1051)[¶](#numpy.distutils.misc_util.Configuration.add_subpackage)
...
``add_data_files``(*self*, **files*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1183-L1332)[¶](#numpy.distutils.misc_util.Configuration.add_data_files)
...
``add_data_dir``(*self*, *data_path*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1053-L1172)[¶](#numpy.distutils.misc_util.Configuration.add_data_dir)
...
``add_include_dirs``(*self*, **paths*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1352-L1366)[¶](#numpy.distutils.misc_util.Configuration.add_include_dirs)
...
``add_headers``(*self*, **files*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1368-L1400)[¶](#numpy.distutils.misc_util.Configuration.add_headers)
...
``add_extension``(*self*, *name*, *sources*, ***kw*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1425-L1526)[¶](#numpy.distutils.misc_util.Configuration.add_extension)
...
``add_library``(*self*, *name*, *sources*, ***build_info*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1528-L1562)[¶](#numpy.distutils.misc_util.Configuration.add_library)
...
``add_scripts``(*self*, **files*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1703-L1717)[¶](#numpy.distutils.misc_util.Configuration.add_scripts)
...
List of the library’s source files. See [add_library](#numpy.distutils.misc_util.Configuration.add_library) for details.
...
``add_npy_pkg_config``(*self*, *template*, *install_dir*, *subst_dict=None*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1631-L1700)[¶](#numpy.distutils.misc_util.Configuration.add_npy_pkg_config)
...
``paths``(*self*, **paths*, ***kws*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1402-L1415)[¶](#numpy.distutils.misc_util.Configuration.paths)
...
``get_config_cmd``(*self*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1757-L1769)[¶](#numpy.distutils.misc_util.Configuration.get_config_cmd)

Returns the numpy.distutils config command instance.


``get_build_temp_dir``(*self*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1771-L1778)[¶](#numpy.distutils.misc_util.Configuration.get_build_temp_dir)

Return a path to a temporary directory where temporary files should be
placed.


``have_f77c``(*self*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1780-L1797)[¶](#numpy.distutils.misc_util.Configuration.have_f77c)
...
``have_f90c``(*self*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1799-L1816)[¶](#numpy.distutils.misc_util.Configuration.have_f90c)
...
``get_version``(*self*, *version_file=None*, *version_variable=None*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L1899-L1967)[¶](#numpy.distutils.misc_util.Configuration.get_version)
...
``make_config_py``(*self*, *name='__config__'*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L2050-L2058)[¶](#numpy.distutils.misc_util.Configuration.make_config_py)
...
``get_info``(*self*, **names*)[[source]](https://github.com/numpy/numpy/blob/master/numpy/distutils/misc_util.py#L2060-L2070)[¶](#numpy.distutils.misc_util.Configuration.get_info)
