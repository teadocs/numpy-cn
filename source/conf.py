...
htmlhelp_basename = 'Chinese-NumPy doc'
...
latex_documents = [
  ('index', 'chinese-numpy.tex', u'NumPy中文文档',
   u'Lisniuse', 'howto'),
]
...
man_pages = [
    ('index', 'chinese-numpy', u'NumPy中文文档',
     [u'Lisniuse'], 1)
]
...
texinfo_documents = [
  ('index', 'chinese-numpy', u'NumPy中文文档',
   u'Lisniuse', 'chinese-numpy', 'NumPy中文文档',
   'Miscellaneous'),
]
